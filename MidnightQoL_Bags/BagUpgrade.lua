...
initFrame:SetScript("OnEvent", function(self, event, arg1)
    ...
    -- Gear swap: do a quick scan now, then a follow-up pass in case item
    -- data wasn't fully cached yet (GetDetailedItemLevelInfo returns 0 until
    -- the client receives the item record from the server).
