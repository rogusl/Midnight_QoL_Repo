-- ============================================================
-- RogUI_Whisper / WhisperUI.lua
-- Whisper tab: general sound, per-person entries.
-- Saves to RogUIDB root (account-wide, not per-spec).
-- ============================================================

local API = RogUIAPI

-- ── Content frame ─────────────────────────────────────────────────────────────
local whisperFrame = CreateFrame("Frame", "RogUIWhisperFrame", UIParent)
...
local function HarvestWhisperUIValues()
    ...
    if RogUIDB then
        RogUIDB.generalWhisperSound     = generalSoundDropdown.selectedSound
        RogUIDB.generalWhisperSoundIsID = generalSoundDropdown.selectedSoundIsID
    end
...
-- ── Add Person button ─────────────────────────────────────────────────────────
local mainFrame = _G["RogUIMainFrame"]
local addWhisperBtn = CreateFrame("Button","RogUIAddWhisperBtn",mainFrame,"GameMenuButtonTemplate")
