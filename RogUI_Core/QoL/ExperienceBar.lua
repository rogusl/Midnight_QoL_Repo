...
-- ── Frame construction ────────────────────────────────────────────────────────
local expBar = CreateFrame("Frame", "RogUIExpBar", UIParent)
...
SlashCmdList["MQOLQUESTDEBUG"] = function()
    print("|cFFFFD700[RogUI QuestXP Debug]|r ========================")
    ...
    print("|cFFFFD700[RogUI QuestXP Debug]|r ======================== done")
end
API.Debug("[RogUI] ExperienceBar loaded.")
